<ul class="nav nav-pills flex-column mt-4">
    ...
    <li class="nav-item">
        <a href="{{ route('admin.charts.index') }}" class="nav-link {{ Request::is('admin/charts*') ? 'active' : '' }}">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#reportsCollapse" role="button" aria-expanded="false"
            ...
            <i class="bi bi-file-earmark-text-fill me-2"></i> Reports List <i class="bi bi-chevron-down float-end"></i>
        </a>
